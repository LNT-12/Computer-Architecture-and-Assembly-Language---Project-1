...
/*
	...
	only '-' at(0)
*/
bool CheckInputDec(std::string& input);
bool CheckInputHex(std::string& input);
bool CheckInputBin(std::string& input);
/*
	index of bit: [0..127]
...
std::string charHexToString(char* hex);

std::string boolToString(bool* bin);

char ComparePositiveString(std::string, std::string);
char CompareNegativeString(std::string, std::string);
